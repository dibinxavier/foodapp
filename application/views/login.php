      ...
      <div class="wrap-login100">
         ...
         <form class="login100-form validate-form">
            ...
            <div class="login_block">
               <div class="out_err log_err" style="padding-bottom: 10px;display: none;">
                  <div class="error_msg"></div>
               </div>
               <div class="out_success log_success" style="padding-bottom: 10px;display: none;">
            ...
            <div class="create_acc_block" style="display: none;">
               <div class="out_err reg_err" style="padding-bottom: 10px;display: none;">
                  <div class="error_msg"></div>
               </div>
               <div class="out_success reg_success" style="padding-bottom: 10px;display: none;">
                  <div class="success_msg"></div>
               </div>
               ...
               <div class="wrap-input100 validate-input" data-validate = "Mobile is required">
                  <input class="input100 create_mob" type="text" name="create_mob" placeholder="Mobile">
                  <span class="focus-input100"></span>
                  <span class="symbol-input100">
       ...
       // $(".error_msg").effect( "shake", { direction: "left", times: 4, distance: 101}, 2000 );
           ...
           $('.register_btn').on('click', function() {
               ...
               if(registered==0){
                   ...
                   if(create_name.length==0 || create_email.length==0 || create_pass.length==0 || create_mob.length==0){
                   } else {
                       length_valid_flag=1;
                   }
                   ...
                   if(create_mob.length<10){
                       $('.create_mob').parent().attr('data-validate','Minimum 10 digits');
                       $('.create_mob').parent().addClass('alert-validate');
                      //register_valid_flag=0;
                   } else{
                       $('.create_mob').parent().attr('data-validate','Mobile is required');
                       $('.create_mob').parent().removeClass('alert-validate');
                       mob_valid_flag=1;
                   }
                   if(length_valid_flag==1 && email_valid_flag==1 && pass_valid_flag==1 && mob_valid_flag==1 ){
